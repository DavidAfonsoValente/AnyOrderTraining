...
def generate_action(
    ...
    # Extract IDs from potential Encoding object
    ...
    full_ids = prompt_ids + [tokenizer.mask_token_id] * gen_length + [role_end_id]
    ...
    # Handle list return from encode
    if isinstance(newline_id, list) and len(newline_id) > 0: newline_id = newline_id[0]
